...
interface Client {
  ...
  gstStatus: 'with_gst' | 'without_gst';
  category: 'individual' | 'corporate' | 'wedding' | 'event';
...
const ClientManagement = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    gstStatus: 'without_gst' as 'with_gst' | 'without_gst',
    category: 'individual' as 'individual' | 'corporate' | 'wedding' | 'event',
